...
client: $(BIN_DIR)/utilitaires.o $(BIN_DIR)/init.o $(BIN_DIR)/client.o
	$(CC) $(CFLAGS) $(BIN_DIR)/utilitaires.o $(BIN_DIR)/init.o $(BIN_DIR)/client.o -o client_exec

serveur: $(BIN_DIR)/utilitaires.o $(BIN_DIR)/init.o $(BIN_DIR)/serveur.o
	$(CC) $(CFLAGS) $(BIN_DIR)/utilitaires.o $(BIN_DIR)/init.o $(BIN_DIR)/serveur.o -o serveur_exec
